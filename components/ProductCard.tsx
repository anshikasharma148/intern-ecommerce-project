...
const ProductCard: React.FC<ProductProps> = ({ product }) => {
  ...
  className="transition-colors duration-300 text-[#1C274C] hover:text-white"
>
  <g
  ...
  <g id="SVGRepo_iconCarrier">
    ...
    />
        ...
        <button
          className="absolute bottom-0 left-0 w-[calc(100%-30px)] bg-black text-white py-2 px-4 rounded opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-4 group-hover:translate-y-0 duration-300 ease-in-out mb-2"
      ...
      <div
        ...
        style={{ height: '40%' }}
      >
        <h3 className="text-sm font-bold cursor-pointer hover:text-orange-500">
          {title}
        </h3>
