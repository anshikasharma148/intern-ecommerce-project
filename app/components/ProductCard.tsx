...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  ...
  return (
    <div
      ...
      style={{ width: '100%', maxWidth: '260px', height: '400px', margin: '10px' }}
    >
